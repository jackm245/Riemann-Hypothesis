...
# Form implementation generated from reading ui file 'ui/tutorial_screens/program_structure_tutorial.ui'
#
...
if __name__ == "__main__":
    ...
    ProgramStructureTutorialScreen = QtWidgets.QDialog()
    ui = Ui_ProgramStructureTutorialScreen()
    ui.setupUi(ProgramStructureTutorialScreen)
    ProgramStructureTutorialScreen.show()
    sys.exit(app.exec_())
