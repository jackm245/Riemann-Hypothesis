...
# Form implementation generated from reading ui file 'ui/investigation_screens/graph_plots.ui'
#
...
"font: 12pt \"Sans Serif\";")
    ...
    def retranslateUi(self, GraphPlotsScreen):
        ...
        self.SubTitleText.setText(_translate("GraphPlotsScreen", "<html><head/><body><p>Visualising the Riemann Hypothsis</p></body></html>"))
...
if __name__ == "__main__":
    ...
    GraphPlotsScreen = QtWidgets.QDialog()
    ui = Ui_GraphPlotsScreen()
    ui.setupUi(GraphPlotsScreen)
    GraphPlotsScreen.show()
    sys.exit(app.exec_())
